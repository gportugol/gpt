...
const char* BasePortugolParser::expecting_fimvar_or_var = "\"fim-variáveis\" ou declaração de variável";
const char* BasePortugolParser::expecting_eof_or_function = "fim do arquivo ou declaração de função";
...
const char* BasePortugolParser::expecting_stm_or_fimse = "comando ou \"fim-se\"";
const char* BasePortugolParser::expecting_stm_or_fimenq = "comando ou \"fim-enquanto\"";
const char* BasePortugolParser::expecting_stm_or_ate = "comando ou \"até\"";
const char* BasePortugolParser::expecting_stm_or_fimpara = "comando ou \"fim-para\"";
...
int BasePortugolParser::reportParserError(int line, const std::string& expecting,
                                          const std::string& found, const std::string& after) {
    std::stringstream s;
...
std::string BasePortugolParser::getTokenDescription(pANTLR3_COMMON_TOKEN token) {
...
bool BasePortugolParser::isDatatype(int tokenType) {
    switch (tokenType) {
        case T_KW_INTEIRO:
        case T_KW_REAL:
        case T_KW_CARACTERE:
